          ...
          <div className="card overflow-hidden">
            ...
            <div className="px-6 py-3 border-t border-border flex flex-wrap items-center gap-4 text-sm text-text-tertiary">
              ...
              {selectedListing.source_url && (
                <a href={selectedListing.source_url} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 text-primary-600 dark:text-primary-400 hover:underline">
